    ...
    Modal.info({
      ...
      content: (
        <div>
          ...
          <ol>
            <li>Нажмите "Backup"</li>
            <li>
              Скачается полный архив со всеми данными и timestamp в имени файла
            </li>
          </ol>
          ...
          <ul>
            ...
            <li>
              <strong>Credentials отправляются на email</strong> асинхронно
            </li>
            <li>
              <strong>Проекты можно указать через запятую</strong> из dropdown
              списка
            </li>
            <li>

...
const Supervisions = () => {
  ...
  const { canUseButton } = useButtonAccess('supervisions')

  // Функция проверки прав на ДОБАВЛЕНИЕ надзора через матрицу доступа
  ...
  // Функция проверки прав на РЕДАКТИРОВАНИЕ надзора через матрицу доступа
  ...
  // Функция проверки прав на ДЕАКТИВАЦИЮ/АКТИВАЦИЮ надзора через матрицу доступа
  ...
  // Функция проверки прав на АРХИВАЦИЮ надзора через матрицу доступа
  ...
  // Функция проверки прав на ВОССТАНОВЛЕНИЕ надзора из архива через матрицу доступа

...
const Contractors = () => {
  ...
  // Функция проверки прав на управление подрядчиками
  // Функция проверки прав на ДОБАВЛЕНИЕ подрядчика
  ...
  // Функция проверки прав на РЕДАКТИРОВАНИЕ подрядчика
  // Доступно: Директор, Главный инженер, Руководитель проекта, Начальник участка, Инженер, Прораб
  ...
  // Функция проверки прав на ДЕАКТИВАЦИЮ/АКТИВАЦИЮ подрядчика
  // Доступно: Директор, Главный инженер, Руководитель проекта, Начальник участка, Инженер, Прораб
  ...
  // Функция проверки прав на АРХИВАЦИЮ подрядчика
  // Доступно: Директор, Главный инженер, Руководитель проекта, Начальник участка, Инженер, Прораб
  ...
  // Функция проверки прав на ВОССТАНОВЛЕНИЕ подрядчика из архива
  ...
  // Функция проверки прав на УДАЛЕНИЕ подрядчика окончательно
